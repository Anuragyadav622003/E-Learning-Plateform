  ...
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-between max-w-screen-2xl container mx-auto px-8 md:px-20 lg:px-24 py-16 md:h-screen">
      ...
      <div className="w-full md:w-1/2 space-y-6 md:space-y-10 text-white pt-10 md:pr-10">
        ...
        {/* Email Input */}
        <label className="flex items-center gap-3 p-3 bg-gray-800 shadow-md transition duration-300 ease-in-out">
          <svg
          ...
          <input
            type="text"
            className="flex-grow h-10 font-semibold text-lg text-gray-200 placeholder-gray-400 focus:outline-none bg-gray-800 rounded-md p-2 border-0 hover:border-2 hover:border-blue-500 transition duration-200 ease-in-out"
